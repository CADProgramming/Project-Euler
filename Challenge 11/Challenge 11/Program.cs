        ...
        static void Main(string[] args)
        {
            ...
            for (int x = 0; x < 20; x++)
            {
                for (int y = 0; y < 20; y++)
                {
                    ...
                    if ((y + 3 < 20) && (x + 3 < 20))
                    {
                        diagonalR = grid[x, y] * grid[x + 1, y + 1] * grid[x + 2, y + 2] * grid[x + 3, y + 3];
                    }
                    if ((y + 3 < 20) && (x - 3 > 0))
                    {
                        diagonalL = grid[x, y] * grid[x - 1, y + 1] * grid[x - 2, y + 2] * grid[x - 3, y + 3];
                    }
                    ...
                    if (diagonalL > product)
                    {
                        product = diagonalL;
                    }
                    if (diagonalR > product)
                    {
                        product = diagonalR;
                    }
                }
